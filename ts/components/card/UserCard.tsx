        ...
        <Grid container spacing={2} paddingTop={2}>
          <Grid item xs={12}>
            <Typography variant="body2">
              {previewText}
              {previewText.length === user.acf.about_me.length ? '' : '...'}
            </Typography>
          </Grid>
          <Grid item xs={6} md={3}>
          ...
          <Grid item xs={6} md={3}>
            <Typography variant="body1">Specialisations</Typography>
            <Typography variant="body2" mb={2}>
              {user.acf.specialisations.join(', ')}
            </Typography>
            <Typography variant="body1">Customer Success Skills</Typography>
